...
export function FoodCard({ id, image, title, price, discount, type, quantity, onIncrease, onDecrease }: FoodCardProps) {
    ...
    <Card className="overflow-hidden">
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" size="icon" className="rounded-full" onClick={onDecrease} disabled={quantity === 0}>
            <Minus className="h-4 w-4" />
          </Button>
          <span className="font-medium">{quantity}</span>
          <Button variant="outline" size="icon" className="rounded-full" onClick={onIncrease}>
